...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      ...
      "img-src 'self' data:",
      "font-src 'self'",
      "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://www.google.com/recaptcha/ https://vitals.vercel-insights.com/",
