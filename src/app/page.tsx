      ...
      <section className="bg-[#0f2d14] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <p className="text-sm font-bold text-white mb-1">Speak directly with our export team</p>
              <p className="text-xs text-white/60">Available via WhatsApp for pricing, samples, and technical questions.</p>
            </div>
